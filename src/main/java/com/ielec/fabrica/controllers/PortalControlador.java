...
public class PortalControlador {
    ...
    public String registro(@RequestParam String nombre,@RequestParam String apellido, @RequestParam String email,
        ...
        try {
            usuarioServicio.registrar( nombre,apellido, email, password);
            ...
            return "registrousuario.html"; // volvemos a cargar el formulario.
        }
    ...
    //     usuarioServicio.actualizar(archivo, id, nombre, email, password);
